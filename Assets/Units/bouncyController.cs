...
public class bouncyController : MonoBehaviour {
    ...
    public float earBobbleForce = 100;
    public void earBobble()
    {
        earL.GetComponent<Rigidbody>().AddRelativeForce(Vector3.left * earBobbleForce);
        earR.GetComponent<Rigidbody>().AddRelativeForce(Vector3.right * earBobbleForce);
